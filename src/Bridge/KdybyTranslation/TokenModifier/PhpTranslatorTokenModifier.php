...
class PhpTranslatorTokenModifier extends TokenModifier
{
    private $translationPattern;

    public function __construct(string $translationPattern = '$this->translator->translate(\'%%%TRANSLATION_KEY%%%\'%%%TRANSLATION_PARAMS%%%)')
    {
